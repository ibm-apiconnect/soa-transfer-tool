...
describe('_test_calculateLocationsAndRewriteDocuments', function() {
	  ...
	  it('calculates location correctly for duplicate names for wsdl', function() {
		  ...
		  wsdlData[0].should.have.property("location", "MathServerService_EP1.wsdl");
		  wsdlData[1].should.have.property("location", "MathServerBinding-8eb1e98e-2769-4947.9708.e84dbae80880.wsdl");
		  wsdlData[2].should.have.property("location", "MathServerBinding-2f5fa82f-bcd3-4314.b797.cdf86ccd971d.wsdl");
		  wsdlData[3].should.have.property("location", "MathServerInterface_InlineSchema1.xsd");
	  ...
	  it('calculates location correctly for duplicate names for xsd', function() {
		  ...
		  wsdlData[0].should.have.property("location", "DoStuffService.wsdl");
		  wsdlData[1].should.have.property("location", "DoStuffService_schema1-1a18001a-e4b5-45b7.a253.3de81a3d538d.xsd");
		  wsdlData[2].should.have.property("location", "DoStuffService_schema1-e9735ae9-8c2f-4f5f.966e.c4204ac46ef7.xsd");

	  });

	  it('calculates location correctly for xsds that produce the same file name', function() {

		  // data which has two imports for XSDs with the same name
		  var wsdlData = [];
		  wsdlData.push({name: "DoStuffService.wsdl", bsrURI: "d2c0b0d2-8fb7-4766.b396.91f4d091967d", content: testData.DoStuffService_relative, type: "WSDLDocument"});
		  wsdlData.push({name: "DoStuffService_schema1.svc?xsd0", bsrURI: "1a18001a-e4b5-45b7.a253.3de81a3d538d", content: testData.DoStuffService_schema1_relative, type: "XSDDocument"});
		  wsdlData.push({name: "DoStuffService_schema1.svc?xsd1", bsrURI: "e9735ae9-8c2f-4f5f.966e.c4204ac46ef7", content: testData.DoStuffService_schema2_relative, type: "XSDDocument"});
	  ...
	  it('calculates location correctly for duplicate top level WSDLs', function() {
		  ...
		  // locations should all be doc names
		  wsdlData[0].should.have.property("location", "MathServerService_EP1-6dc15f6d-d784-441c.a4c1.25565525c1b6.wsdl");
		  wsdlData[1].should.have.property("location", "MathServerService_EP1-67b78c67-f017-47f5.aaf6.fcca87fcf69f.wsdl");
		  wsdlData[2].should.have.property("location", "MathServerBinding.wsdl");
		  wsdlData[3].should.have.property("location", "MathServerInterface.wsdl");
		  wsdlData[4].should.have.property("location", "MathServerInterface_InlineSchema1.xsd");
